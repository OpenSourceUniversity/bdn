...
class Profile(m.Model):
    ...
    learner_about = m.TextField(max_length=2000, blank=True, null=True)
    ...
    academy_about = m.TextField(max_length=2000, blank=True, null=True)
    ...
    company_about = m.TextField(max_length=2000, blank=True, null=True)
