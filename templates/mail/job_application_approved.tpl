...
{% block subject %}Open Source University - Your application for {{ job_title }} is APPROVED{% endblock %}

{% block header_title %}Your application for {{ job_title }} is APPROVED by {{ issuer_name }}{% endblock %}
    ...
    <td mc:edit="text003" align="center" class="text_color_282828" style="color: #282828; font-size: 15px; line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
      <div class="editable-text" style="line-height: 2;">
        <span class="text_container">
          <multiline>
            You are one step closer to your new professional challenge. We are happy for you and wish you success. Be prepared for the next stage of the interview:
          </multiline>
        </span>
      </div>
    </td>
