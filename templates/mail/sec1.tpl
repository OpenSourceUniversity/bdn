							...
							<tr>
								<td align="center">
									<div class="editable-img">
										<img editable="true" mc:edit="image003" src="images/circle-icon-person.png"  style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="" />
									</div>
								</td>
							</tr>
				...
				<tr>
					<td>
						...
						<table class="container_400" align="center" width="400" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
							...
							<tr>
								<td mc:edit="text005" align="center" class="text_color_282828" style="color: #282828; font-size: 15px;font-style: italic; line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
									<div class="editable-text" style="line-height: 2;">
										<span class="text_container">
											<multiline>
